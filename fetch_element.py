...
# Fetch element
def get_text(url, selector_name, selector, computer_os, wait, openvpn_file, openvpn_file_path, retry_vpn, cookie):
    try:
        response = requests.get(url, cookies=cookie)
    except requests.exceptions.RequestException as e:
        return retry_everything(url, selector_name, selector, computer_os, wait, openvpn_file, openvpn_file_path, cookie)
